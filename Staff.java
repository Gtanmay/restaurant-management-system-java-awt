...
public abstract class Staff
{
    ...
    public Staff( String newID, String newLastName, String newFirstName, String newPassword)
    {
        setID( newID);
    ...
    public double culculateWorkTime()
    {
        if(getWorkState() != WORKSTATE_FINISH)
            return 0;
        if(finishWorkTime == null || startWorkTime == null){
            return 0;
        }
